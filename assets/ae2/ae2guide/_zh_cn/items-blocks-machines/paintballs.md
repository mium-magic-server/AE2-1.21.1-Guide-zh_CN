...
染色球用于<ItemLink id="color_applicator" />中，以便为可染色的方块（如[线缆](cables.md)、羊毛、陶瓦、玻璃和混凝土）上色。它们也可用于<ItemLink id="matter_cannon" />中，以射出小块颜料斑点。
...
它们的作用与普通染色球相同，但从<ItemLink id="matter_cannon" />中射出时，斑点会发光。我想这可以作为一种信号弹使用。
